 ...
 * ```
 */
L.VectorGrid.Json = L.VectorGrid.extend({
...
// 			z: this._getZoomForUrl()	/// TODO: Maybe replicate TileLayer's maxNativeZoom
		...
		return fetch(tileUrl, this.options.fetchOptions).then(function(response){
			...
			return response.json().then( function (data) {
 				//console.log(data);
				//return data with Promises take data to resolve
...
// 🍂factory L.vectorGrid.json(url: String, options)
// Instantiates a new json VectorGrid with the given URL template and options
L.vectorGrid.json = function (url, options) {
	return new L.VectorGrid.Json(url, options);
};
